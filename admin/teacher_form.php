    ...
    <div class="layout-container">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card mb-4">
                        ...
                        <p class=" text-end">Download the Model Template : <a href="model_template_teacher.csv"><i class="bx bx-download btn btn-primary btn-sm me-2"></i></a></p></h5>
                        <div class="card-body">
        ...
        <div class="invalid-feedback"><i class='bx bx-error-circle'></i>Please upload a CSV file.</div>
                    ...
                    <div class="card mb-4">
                        ...
                        <h5 class="card-header">Teacher Registration</h5>
                     

                        <div class="card-body">
                        <div class="col-sm">
                        <p class="text-right " style="justify-content:center;">
                            This module enables admin to upload (.csv)  or manually enter teachers details for efficient
                            management. </p>
                            </div>
                            <form action="add_teacher.php" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label for="exampleFormControlInput1" class="form-label">Teacher Name<span
                                                style="color:red;">*</span></label>
                                                <input type="text" name="name" class="form-control"
                                            id="exampleFormControlInput1" placeholder="Enter Teacher Name"
                                            pattern="[A-Za-z. ]+" title="Only letters and full stops are allowed"
                                            required />
                                    ...
                                    <input class="form-control" type="date" name="dateofbirth" id="exampleFormControlReadOnlyInput1" placeholder="Date of Birth" required />
                                        <div class="invalid-feedback"><i class='bx bx-error-circle'></i>Please enter a valid date of birth.</div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="exampleFormControlReadOnlyInput1" class="form-label">Phone
                                            Number<span style="color:red;">*</span></label>
                                            <input class="form-control" type="text" name="phone" id="phoneNumber" placeholder="Enter mobile number" minlength="10" maxlength="10" pattern="^[6789][0-9]{9}$" title="Please enter a 10-digit number starting with 6, 7, 8, or 9." required>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control" type="email" name="email" id="email_tag"
                                            placeholder="Enter Your email" required>
                                        <div class="invalid-feedback"><i class='bx bx-error-circle'></i>Please enter a valid email address.</div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="exampleFormControlSelect1" class="form-label">Class<span
                                                style="color:red;">*</span></label>
                                        <select class="form-select" id="classSelect" name="tclass"
                                            aria-label="Select Class" required>
                                            <option value="">Select Class</option>
                                            <?php
                                            include "db_config.php";
                                            $query = "SELECT DISTINCT class FROM admin_details";
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="sectionSelect" class="form-label">Section<span
                                                style="color:red;">*</span></label>
                                        <select class="form-select" id="sectionSelect" name="tsection"
                                            aria-label="Select Section" required>
                                    ...
                                    <div class="mb-3 text-end col-md-12">
                                        <input type="submit" class="btn btn-outline-primary"
                                            id="inputGroupFileAddon03button" aria-describedby="inputGroupFileAddon03"
                                            aria-label="Upload" name="submit" value="Submit">
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    ...
    function nameValidation(event) {
        ...
        var regex = /^[a-zA-Z]+$/; // Regex to allow only alphabetic characters
    ...
    // Function to validate phone number (starts with 6, 7, 8, or 9 and is 10 digits)
    ...
    // Attach validation to the respective input fields
    $('#exampleFormControlInput1').on('input', nameValidation);
    $('#phoneNumber').on('input', phoneNumberValidation);
    ...
    $('form').submit(function (event) {
        ...
        if (fileInput.length > 0 && !fileInput.val()) {
            ...
            fileInput.next('.invalid-feedback').show();
        } else {
...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.2/dist/umd/popper.min.js"
        integrity="sha384-0V/Vd9U8NMX5ZDOLOyJpBMGA2wtmh1j6vCGdS8F9bLOz4XC0o4Bab3djBhQv8yH+" crossorigin="anonymous">
    </script>
